...
<main class="lp-hero">
  ...
  <div class="lp-cards" style="justify-content:center">
    <a href="menu.php" class="lp-card">
      ...
      <div class="lp-card-title">Ver Cardápio</div>
      <div class="lp-card-desc">Faça seu pedido online pelo WhatsApp</div>
    </a>
  </div>
