...
--
-- Host: 127.0.0.1
-- Tempo de geração: 13/05/2026 às 22:55
...
INSERT INTO `clientes` (`id`, `nome`, `whatsapp`, `senha_hash`, `total_pedidos`, `total_gasto`, `pontos`, `ultimo_pedido`, `created_at`) VALUES
(1, 'aaa', '51999999999', '$2y$10$JdPlXBC9CbPya2/NehwtWOvB9t/4fFA70cH3vuEK7NC2aUxlZPkU.', 0, 0.00, 0, NULL, '2026-05-13 17:40:08');
...
INSERT INTO `ingredientes` (`id`, `nome`, `emoji`, `ativo`, `created_at`) VALUES
(1, 'Bacon', '🍴', 1, '2026-05-13 20:52:53');
...
INSERT INTO `produto_opcoes` (`id`, `produto_id`, `tipo`, `nome`, `preco`, `emoji`, `ordem`, `ativo`, `created_at`) VALUES
(1, 1, 'remover', 'Alface', 0.00, '🥬', 1, 1, '2026-05-13 19:52:33'),
(2, 1, 'remover', 'Tomate', 0.00, '🍅', 2, 1, '2026-05-13 19:52:33'),
(3, 1, 'remover', 'Maionese', 0.00, '🫙', 3, 1, '2026-05-13 19:52:33'),
(4, 1, 'remover', 'Cebola', 0.00, '🧅', 4, 1, '2026-05-13 19:52:33'),
(5, 1, 'remover', 'Molho especial', 0.00, '🟤', 5, 1, '2026-05-13 19:52:33'),
(6, 1, 'extra', 'Bacon extra', 3.50, '🥓', 1, 1, '2026-05-13 19:52:33'),
(7, 1, 'extra', 'Queijo extra', 2.00, '🧀', 2, 1, '2026-05-13 19:52:33'),
(8, 1, 'extra', 'Ovo frito', 2.00, '🍳', 3, 1, '2026-05-13 19:52:33'),
(9, 1, 'extra', 'Cheddar cremoso', 3.00, '🫕', 4, 1, '2026-05-13 19:52:33'),
(10, 2, 'remover', 'Bacon', 0.00, '🥓', 1, 1, '2026-05-13 19:52:33'),
(11, 2, 'remover', 'Cheddar', 0.00, '🧀', 2, 1, '2026-05-13 19:52:33'),
(12, 2, 'remover', 'Molho barbecue', 0.00, '🟤', 3, 1, '2026-05-13 19:52:33'),
(13, 2, 'extra', 'Ovo frito', 2.00, '🍳', 1, 1, '2026-05-13 19:52:33'),
(14, 2, 'extra', 'Alface', 1.00, '🥬', 2, 1, '2026-05-13 19:52:33'),
(15, 2, 'extra', 'Tomate', 1.00, '🍅', 3, 1, '2026-05-13 19:52:33'),
(16, 3, 'remover', 'Alface', 0.00, '🥬', 1, 1, '2026-05-13 19:52:33'),
(17, 3, 'remover', 'Tomate', 0.00, '🍅', 2, 1, '2026-05-13 19:52:33'),
(18, 3, 'remover', 'Maionese temperada', 0.00, '🫙', 3, 1, '2026-05-13 19:52:33'),
(19, 3, 'extra', 'Queijo', 2.00, '🧀', 1, 1, '2026-05-13 19:52:33'),
(20, 3, 'extra', 'Bacon', 3.50, '🥓', 2, 1, '2026-05-13 19:52:33'),
(21, 3, 'extra', 'Cheddar', 3.00, '🫕', 3, 1, '2026-05-13 19:52:33');
...
--
ALTER TABLE `produto_opcoes`
  ADD CONSTRAINT `produto_opcoes_ibfk_1` FOREIGN KEY (`produto_id`) REFERENCES `produtos` (`id`) ON DELETE CASCADE;
